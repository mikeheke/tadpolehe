...
public class ApplicationDao extends BaseDao<Application, String> implements IApplicationDao {
	...
	/* (non-Javadoc)
	 * @see mikeheke.tadpole.frm.afw.dao.IApplicationDao#getApplicationList(mikeheke.tadpole.frm.afw.entity.UserProfile)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see mikeheke.tadpole.frm.afw.dao.IApplicationDao#getApplication(mikeheke.tadpole.frm.afw.entity.Application)
	 */
	@Override
