...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:tvns>
  ...
  <frameset rows="115,*" frameborder="no" border="0" framespacing="0" >
	...
	<frameset cols="*,1024,*" frameborder="no" border="0" framespacing="0">
		...
		<frame src="<%=basePath %>/mnu/tree/top.jsp?_appContext_=${param._appContext_ }" name="top" scrolling="no" noresize id="top" ></frame>	
		<frame src="about:blank" scrolling="no"></frame>
	</frameset>
	
	<frameset id="bodyFrame" cols="*,204,18,802,*" frameborder="no" border="0" framespacing="0" >
		<frame src="about:blank" scrolling="no"></frame>
	    <frame src="<%=basePath %>/mnu/tree/left.jsp" name="left" scrolling="auto" noresize id="left" ></frame>
	    <frame src="<%=basePath %>/mnu/tree/leftRight.jsp" name="leftRight" scrolling="no" noresize id="leftRight" ></frame>
