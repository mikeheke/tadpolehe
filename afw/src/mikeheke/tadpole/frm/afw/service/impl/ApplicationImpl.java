...
import mikeheke.tadpole.frm.afw.dao.IApplicationDao;
...
public class ApplicationImpl extends BaseImpl implements ApplicationService{
	...
	/* (non-Javadoc)
	 * @see mikeheke.tadpole.frm.afw.service.ApplicationService#getApplications(mikeheke.tadpole.frm.afw.entity.UserProfile)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see mikeheke.tadpole.frm.afw.service.ApplicationService#getApplications()
	 */
	@Override
...
//		moduleTimeTask.setModuleId(applicationDao.generateSequence("MSTB_MODULE"));		
	...
	/* (non-Javadoc)
	 * @see mikeheke.tadpole.frm.afw.service.ApplicationService#getApplication(mikeheke.tadpole.frm.afw.entity.Application)
	 */
	@Override
