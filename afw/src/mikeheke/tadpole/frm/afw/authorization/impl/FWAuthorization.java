package mikeheke.tadpole.frm.afw.authorization.impl;
...
//		cookie.setDomain(LOCAL_COOKIE_DOMAIN);					// 设置域名
	...
	/* (non-Javadoc)
	 * @see mikeheke.tadpole.frm.afw.authorization.IFWAuthorization#removeAuthorizate(javax.servlet.http.HttpServletRequest, javax.servlet.http.HttpServletResponse)
	 */
	@Override
