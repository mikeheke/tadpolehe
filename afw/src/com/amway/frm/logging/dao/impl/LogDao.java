 ...
 * 
 */
package com.amway.frm.logging.dao.impl;
...
public class LogDao extends BaseDao implements ILogDao {
	...
	/* (non-Javadoc)
	 * @see com.amway.frm.logging.dao.ILogDao#saveOperation(com.amway.frm.logging.entity.LogOperation)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.amway.frm.logging.dao.ILogDao#savePerformace(com.amway.frm.logging.entity.LogPerformance)
	 */
	@Override
