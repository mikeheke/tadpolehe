...
public class RoleRightImpl extends BaseImpl implements RoleRightService{
	...
	/* (non-Javadoc)
	 * @see com.amway.frm.afw.services.RoleRightService#copyRight(com.amway.frm.afw.entity.Role, com.amway.frm.afw.entity.Role)
	 */
	@Transactional
	@Override
	...
	/* (non-Javadoc)
	 * @see com.amway.frm.afw.services.RoleRightService#disRights(com.amway.frm.afw.entity.Role, java.util.List)
	 */
	@Transactional
	@Override
	...
	/* (non-Javadoc)
	 * @see com.amway.frm.afw.services.RoleRightService#getMRightList(java.util.List)
	 */
	@Override
